# Module Name: HandleExcelConfig.py
...
import matplotlib.transforms as plt_trans
...
class ReadUsageData:
    ...
    TODO: Handle aspect ratio dynamically
    TODO: Handle chip legend size dynamically
    ...
    def PlotData(self):
        ...
        plt.savefig('stacked_area_chart.png', dpi=100)